 ...
 */
final class Version20190409155005 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE person ADD lastname VARCHAR(255) DEFAULT NULL, DROP name');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE person ADD name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP lastname');
    }
}
